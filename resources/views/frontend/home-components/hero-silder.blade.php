                        ...
                        <div class="top__news__slider">
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('frontend/asset/images/newsimage5.png') }}"
                                                alt="" class="img-fluid">
                                        </a>
                                    </div>
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('frontend/asset/images/newsimage6.png') }}"
                                                alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('frontend/asset/images/newsimage7.png') }}"
                                                alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
                            ...
                            <div class="item">
                                ...
                                <div class="article__entry">
                                    <div class="article__image">
                                        <a href="#">
                                            <img src="{{ asset('frontend/asset/images/newsimage8.png') }}"
                                                alt="" class="img-fluid">
                                        </a>
                                    </div>
                                    <div class="article__content">
