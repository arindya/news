...
--
-- Host: 127.0.0.1
-- Waktu pembuatan: 12 Feb 2025 pada 03.10
...
(1, 'uploads/EKIABPcZLJ0EvV2kLoMM4eST6n8whJ.jpg', 'Super Admin', 'admin@gmail.com', NULL, '$2y$10$NnU1IvivU/HEti6oJ9gm3Ohd5a7PULybXKlQ/IjbkiQj8oUxLw0CS', 1, 'fmrIq3f2DmiUmTEc5EPR4GKVSpBW91dGx4XOBoyZW4FJL9BJqWj6kfgoE4Qf', '2023-08-18 22:56:15', '2023-08-26 02:20:59'),
...
(1, 'uploads/09UF0tD3WF9xMt1EDoxnjYB7XXY5q8.png', 0, 'uploads/m5IQnCsK9d3nO4nO6vKEK6rBbf7cgT.png', 0, 'uploads/ZzaCdWrej3oyDP5ABJ6eManq8LTRDY.png', 0, 'uploads/1MvD8y9Qoy3d9rBDd7nIkCDMWxdXVm.png', 0, 'uploads/Gr5Mp1wLpmifc145IM01bFEVJzq9dC.png', 0, 'https://github.com', 'https://github.com', 'https://github.com', 'https://github.com', 'https://github.com', '2023-08-24 23:59:53', '2025-02-11 06:53:16');
...
(7, 'en', 'test2', 'test2', 1, 1, '2025-02-10 23:43:40', '2025-02-10 23:43:40');
...
CREATE TABLE `news` (
  ...
  `created_at` timestamp NULL DEFAULT NULL,
  `updated_at` timestamp NULL DEFAULT NULL,
  `ytembed` varchar(99) DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci;
...
INSERT INTO `news` (`id`, `language`, `category_id`, `author_id`, `image`, `title`, `slug`, `content`, `meta_title`, `meta_description`, `is_breaking_news`, `show_at_slider`, `show_at_popular`, `status`, `is_approved`, `views`, `created_at`, `updated_at`, `ytembed`) VALUES
...
--
-- Struktur dari tabel `received_mails`
--
...
--
-- Dumping data untuk tabel `received_mails`
--

INSERT INTO `received_mails` (`id`, `email`, `subject`, `message`, `seen`, `replied`, `created_at`, `updated_at`) VALUES
(1, 'phandinhhungvp2001@gmail.com', 'Pay via paypal', 'no', 1, 1, '2023-08-25 03:39:49', '2025-02-11 07:05:01');
...
--
-- Dumping data untuk tabel `social_counts`
--
...
(2, 'm.sultanalfarid15@gmail.com', '2025-02-11 07:03:36', '2025-02-11 07:03:36');
...
(49, 'bisnis', 'en', '2025-02-11 06:51:15', '2025-02-11 06:51:15'),
(50, 'test', 'en', '2025-02-11 18:23:01', '2025-02-11 18:23:01');
...
(2, 'sultan', 'm.sultanalfarid15@gmail.com', NULL, '$2y$10$hZGQ0NLpHoWc9jF1IttU8e3gfXZvjK5MwxCGq2YXfodaubRnImh0S', NULL, '2025-02-11 07:03:16', '2025-02-11 07:03:16');
...
--
-- Indeks untuk tabel `received_mails`
--
...
--
-- AUTO_INCREMENT untuk tabel `received_mails`
--
ALTER TABLE `received_mails`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
